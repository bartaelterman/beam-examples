...
public class DistinctProductsPerSaleTransform extends PTransform<PCollection<String>, PCollection<KV<String, String>>> {

    private static final int WINDOWGAPDURATION = 600;
    private static final int TRIGGERINGTIME = 30;
    static final Logger LOG = LoggerFactory.getLogger(DistinctProductsPerSaleTransform.class);
